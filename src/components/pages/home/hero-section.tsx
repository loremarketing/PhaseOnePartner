...
export default function HeroSection() {
  return (
    <section className="w-full h-full pt-32
     pb-32 mx-auto px-6 lg:px-16 lg:min-h-screen [@media(min-width:1600px)]:min-h-auto [@media(min-width:1600px)]:py-62 relative z-10 bg-[#f0f0f0] lg:flex lg:items-center">
