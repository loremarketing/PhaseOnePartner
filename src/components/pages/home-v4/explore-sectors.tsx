import SectorLink from "./sector-link";
import { cn } from "@/lib/utils";
import { SVGIcon } from "@/components/ui/svg-icon";

/**
 * Figma 1555:571 (desktop) / 1555:1009 (mobile).
 * Each pill deep-links to its own band on /industries; the slugs have to
 * stay in step with INDUSTRIES in industries-data.ts, which owns the ids.
