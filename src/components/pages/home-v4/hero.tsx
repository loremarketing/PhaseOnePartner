  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-6 pb-24 pt-36 lg:px-[clamp(24px,4.167vw,60px)] lg:pb-[clamp(80px,20.7vw,208px)] lg:pt-[clamp(180px,20.486vw,295px)]">
        <p className="font-manrope text-[14px] font-normal uppercase leading-[22px] text-white lg:text-[16px]">
          Deal origination for private capital · Australia &amp; New Zealand
        </p>

        <h1 className="mt-5 font-manrope text-[32px] font-bold uppercase leading-[42px] text-white sm:text-[40px] lg:mt-[22px] lg:max-w-[903px] lg:text-[clamp(2.5rem,4.444vw,4rem)] lg:leading-[clamp(3rem,5.139vw,4.625rem)]">
          Proprietary deal flow, before the market sees it.
        </h1>

        <p className="mt-6 font-inter text-[16px] font-normal leading-[26px] text-white lg:mt-1 lg:max-w-[843px] lg:text-[clamp(1rem,1.25vw,1.125rem)] lg:leading-[clamp(1.5rem,1.944vw,1.75rem)]">
        ...
        <div className="mt-8 flex flex-col gap-4 sm:flex-row lg:mt-[45px]">
