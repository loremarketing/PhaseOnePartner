    ...
    >
      <div className="mx-auto flex w-full max-w-[1440px] flex-col px-4 lg:px-[clamp(24px,4.167vw,60px)]">
        ...
        <div
          ...
          className="mt-8 space-y-5 font-inter text-[16px] font-normal leading-[26px] text-white lg:text-[clamp(1rem,1.25vw,1.125rem)] lg:leading-[clamp(1.5rem,1.944vw,1.75rem)]">
