  ...
  return (
    <section className="bg-white py-16 lg:py-[100px]">
      <div className="mx-auto w-full max-w-[1440px] px-4 lg:px-[clamp(24px,4.167vw,60px)]">
        ...
        <h2 className="mt-4 font-manrope text-[32px] font-medium leading-[42px] text-[#333] lg:max-w-[736px] lg:text-[clamp(2.5rem,4.444vw,4rem)] lg:leading-[clamp(2.875rem,4.861vw,4.375rem)]">
          Why origination matters in{" "}
          <span className="text-[#0224e9]">private markets</span>
        </h2>
        <p className="mt-6 font-inter text-[16px] font-normal leading-[26px] text-[#333] lg:max-w-[776px] lg:text-[clamp(1rem,1.25vw,1.125rem)] lg:leading-[clamp(1.5rem,1.944vw,1.75rem)]">
